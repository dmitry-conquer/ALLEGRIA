<template>
  <div
    ...
    <div class="flex max-lg:pt-8 flex-col justify-center divide-x overflow-auto lg:flex-row lg:border-b lg:border-t relative">
      <button @click="emit('close-menu')" class="absolute right-4 top-1" type="button">
        <IconClose class="w-7 h-7 stroke-primary-dark"/>
      </button>
      <div
        v-for="t in types"
        class="px-6 pr-24 lg:px-16 py-2 lg:py-12">
        <div
          role="button"
          @click="handleSpoiler"
